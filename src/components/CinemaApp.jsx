...
const SEED_MOVIES = [
  ...
  {id:uid(),title:"Harry Potter and the Sorcerer’s Stone",year:2001,category:"Epic Sagas",ageMin:7,ageIdeal:8,series:"Harry Potter",mustWatch:true,description:"The beginning of one of cinema’s greatest coming-of-age sagas.",watchOrder:"1 through 8 in order. All required.",_enriched:true},
  ...
  {id:uid(),title:"National Lampoon’s Christmas Vacation",year:1989,category:"Comedy",ageMin:10,ageIdeal:11,series:"",mustWatch:true,description:"Clark Griswold’s quest for the perfect Christmas.",watchOrder:"Annual Christmas tradition.",_enriched:true},
  {id:uid(),title:"It’s a Wonderful Life",year:1946,category:"Drama",ageMin:8,ageIdeal:10,series:"",mustWatch:true,description:"The ultimate film about legacy and meaning.",watchOrder:"Every Christmas, forever.",_enriched:true},
  ...
  {id:uid(),title:"Ferris Bueller’s Day Off",year:1986,category:"Comedy",ageMin:12,ageIdeal:13,series:"",mustWatch:true,description:"Life moves pretty fast. A love letter to living in the moment.",watchOrder:"Standalone.",_enriched:true},
